 ...
 */
final class Version20240520100309 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE content (id INT AUTO_INCREMENT NOT NULL, course_id INT DEFAULT NULL, type VARCHAR(20) NOT NULL, title VARCHAR(20) NOT NULL, description LONGTEXT DEFAULT NULL, document JSON DEFAULT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_FEC530A9591CC992 (course_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE course (id INT AUTO_INCREMENT NOT NULL, id_user_id INT DEFAULT NULL, title VARCHAR(20) NOT NULL, description LONGTEXT DEFAULT NULL, level VARCHAR(20) NOT NULL, subject VARCHAR(20) NOT NULL, INDEX IDX_169E6FB979F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
